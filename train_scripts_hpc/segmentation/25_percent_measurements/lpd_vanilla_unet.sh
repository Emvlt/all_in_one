...
#! Name of the job:
#SBATCH -J 25_percent_lpd_vanilla_unet
...
options="experiences.py --platform hpc --metadata_path metadata_folder/segmentation/25_percent_measurements/lpd_vanilla_unet.json"
