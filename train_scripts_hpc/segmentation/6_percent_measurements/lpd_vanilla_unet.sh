...
#! Name of the job:
#SBATCH -J 6_percent_lpd_vanilla_unet
...
options="experiences.py --platform hpc --metadata_path metadata_folder/segmentation/6_percent_measurements/lpd_vanilla_unet.json"
