...
#! Name of the job:
#SBATCH -J 6_percent_ramp_filter_vanilla_unet
...
options="experiences.py --platform hpc --metadata_path metadata_folder/segmentation/6_percent_measurements/ramp_filter_vanilla_unet.json"
