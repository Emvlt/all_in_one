...
#! Name of the job:
#SBATCH -J lpd_1_layer_full_dataset_L1_sinogram_loss
...
options="experiences.py --platform hpc --metadata_path metadata_folder/reconstruction/100_percent_measurements/lpd_1_layer_full_dataset_L1_sinogram_loss.json"
