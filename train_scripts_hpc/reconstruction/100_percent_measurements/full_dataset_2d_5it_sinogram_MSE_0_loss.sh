...
options="experiences.py --platform hpc --metadata_path metadata_folder/reconstruction/100_percent_measurements/full_dataset_2d_5it_sinogram_MSE_0_loss.json"
