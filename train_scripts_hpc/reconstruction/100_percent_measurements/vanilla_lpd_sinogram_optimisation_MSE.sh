...
#! Name of the job:
#SBATCH -J vanilla_lpd_sinogram_optimisation_MSE
...
options="experiences.py --platform hpc --metadata_path metadata_folder/reconstruction/100_percent_measurements/vanilla_lpd_sinogram_optimisation_MSE.json"
