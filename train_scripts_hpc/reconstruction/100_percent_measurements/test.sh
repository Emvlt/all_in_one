#!/bin/bash
#SBATCH -J 1d_lpd_sinogram_optimisation_MSE
...
options="experiences.py --platform hpc --metadata_path metadata_folder/reconstruction/100_percent_measurements/1d_lpd_sinogram_optimisation_MSE.json"
