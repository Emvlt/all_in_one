...
#! Name of the job:
#SBATCH -J train_lpd_1_layer_full_dataset
...
options="experiences.py --platform hpc --metadata_path metadata_folder/reconstruction/100_percent_measurements/lpd_1_layer_full_dataset.json"
