...
options="experiences.py --platform hpc --metadata_path metadata_folder/reconstruction/6_percent_measurements/lpd_1_layer_full_dataset_L1_sinogram_loss.json"
