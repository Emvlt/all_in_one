...
options="experiences.py --platform hpc --metadata_path metadata_folder/reconstruction/6_percent_measurements/full_dataset_1d_5it_sinogram_MSE_0.5_loss.json"
