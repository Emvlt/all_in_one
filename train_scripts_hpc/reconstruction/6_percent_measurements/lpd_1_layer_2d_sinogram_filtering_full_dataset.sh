...
options="experiences.py --platform hpc --metadata_path metadata_folder/reconstruction/6_percent_measurements/lpd_1_layer_2d_sinogram_filtering_full_dataset.json"
