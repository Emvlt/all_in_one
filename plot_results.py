...
PIPELINE_FOLDERS = {
    'reconstruction': ['6_percent_measurements', '25_percent_measurements', '100_percent_measurements'],
    'segmentation': ['from_input_images', '6_percent_measurements', '25_percent_measurements', '100_percent_measurements']
    }
...
def compare_methods(patient_name:str, results_path:pathlib.Path, pipeline:str, experiment_tracker:List):
    for experiment_folder in PIPELINE_FOLDERS[pipeline]:
        ...
        for experiment_name in experiment_tracker:
            path_to_run = results_path.joinpath(f'{pipeline}/{experiment_folder}/{experiment_name}.json')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--patient_list', default=['LIDC-IDRI-0200'])
