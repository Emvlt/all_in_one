...
#! Name of the job:
#SBATCH -J train_lpd_ramp_fourier_filtering
...
options="evaluate.py --quantitative --platform hpc --metadata_path metadata_folder/reconstruction/100_percent_measurements/lpd_ramp_fourier_filtering.json"
