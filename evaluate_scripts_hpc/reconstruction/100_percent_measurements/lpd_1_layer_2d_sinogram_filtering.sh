...
options="evaluate.py --quantitative --platform hpc --metadata_path metadata_folder/reconstruction/100_percent_measurements/lpd_1_layer_2d_sinogram_filtering.json"
