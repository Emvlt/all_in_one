...
#! Name of the job:
#SBATCH -J train_lpd_L1_sinogram_loss
...
options="evaluate.py --quantitative --platform hpc --metadata_path metadata_folder/reconstruction/100_percent_measurements/lpd_L1_sinogram_loss.json"
