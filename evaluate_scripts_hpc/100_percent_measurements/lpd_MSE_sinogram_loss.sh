...
#! Name of the job:
#SBATCH -J train_lpd_MSE_sinogram_loss
...
options="evaluate.py --quantitative --platform hpc --metadata_path metadata_folder/reconstruction/100_percent_measurements/lpd_MSE_sinogram_loss.json"
